...
const credentials = [
  { icon: "/figma/imgPremium187273551.svg", value: "10+", label: "Tahun Pengalaman" },
  { icon: "/figma/imgLayer2.svg", value: "15,000+", label: "Pasien Ditangani" },
  { icon: "/figma/imgShield131932661.svg", value: "92%", label: "Patient Satisfaction" },
];
        ...
        <div className="-rotate-90 flex-none w-[100cqh]">
          <div className="h-0 relative w-full">
            <div className="absolute inset-[-1px_0_0_0]">
              <img alt="" className="block max-w-none size-full" src="/figma/imgLine6.svg" />
            </div>
          </div>
        </div>
      </div>
      ...
      <section className="w-full flex justify-center px-6 -mt-2 mb-12 relative z-10">
        <div className="max-w-[1240px] w-full backdrop-blur-[11px] bg-[rgba(255,248,242,0.85)] rounded-[32px] px-[64px] py-[32px] shadow-[0px_18px_40px_rgba(56,0,30,0.08)]">
          <div className="flex items-center justify-between w-full">
            {credentials.map((c, i) => (
              <div key={i} className="flex gap-[20px] items-center shrink-0">
